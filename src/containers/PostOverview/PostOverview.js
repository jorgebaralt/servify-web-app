			...
			<>
				...
				<div className={classes.WhyContainer}>
					<div className={classes.WhyDiv}>
						<h2 className={classes.SecondTitle}>Why pick Servify?</h2>
				...
				<div className={classes.HowToPostContainer}>
					...
					<div className={classes.HowToPostStep}>
						...
						<h2 className={classes.SecondTitle}>Post your service</h2>
					...
					<div className={classes.HowToPostStep}>
						...
						<h2 className={classes.SecondTitle}>Get contacted for jobs</h2>
				...
				<div className={classes.WhatUsersSeeContainer}>
					<div className={classes.WhatUsersSeeImgContainer}>
						<img className={classes.WhatUsersSeeImg} src={require('../../assets/images/happy.jpg')} alt="" />
					</div>
					<div className={classes.WhatUsersSeeDescriptionContainer}>
						<ul className={classes.ListContainer}>
							<li className={classes.ListItem}> <ListStar style={{ width: 24, height: 24}}/> Reviews and rating of your service</li>
							<li className={classes.ListItem}> <ListStar style={{ width: 24, height: 24}}/> Service category and information</li>
							<li className={classes.ListItem}> <ListStar style={{ width: 24, height: 24}}/> Your contact information</li>
							<li className={classes.ListItem}> <ListStar style={{ width: 24, height: 24}}/> Location of your service (Map)</li>
							<li className={classes.ListItem}> <ListStar style={{ width: 24, height: 24 }} /> Easy way to contact you</li>
							<li className={classes.ListItem}> <ListStar style={{ width: 24, height: 24 }} /> Option to add to favorites</li>
						</ul>
					</div>
				</div>
